...
(async () => {
    ...
    const about = `Vladimír Gorej is a Prague-based **Software Engineer** passionate about software and code quality. Over the years, he has worked as Technical Team Lead at Oracle, Principal Software Engineer at Apiary, and Senior Open Source Engineer at SmartBear, along with other senior engineering and leadership roles at Ubiquiti Networks and SecurityScorecard. Active in the Open Source community for more than fifteen years, he now applies this experience as a Senior Software Engineer (AI) at Jentic. Vladimír holds all Open Source Best Practices certifications awarded by The Linux Foundation. His contributions have been recognized as an alumni member of the [GitHub Stars program](https://stars.github.com/alumni/#:~:text=char0n) and through his five years as a maintainer of [Swagger tools](https://swagger.io). He also plays a pivotal role in shaping the future of asynchronous APIs as a [maintainer of the AsyncAPI specification](https://github.com/asyncapi/spec). His favorite programming languages include **JavaScript**, **TypeScript**, **Python**, and **Elixir**.`;
    const specLynx = `<br><div><h2>SpecLynx</h2><p><a href="https://speclynx.com/" target="_blank" rel="noreferrer nofollow"><img align="left" width="100" height="100" src="https://vladimirgorej.com/assets/img/speclynx-logo.webp"></a></p><p>Vladimír is a <strong>co-founder</strong> of <a href="https://speclynx.com/">SpecLynx - The OpenAPI Powerhouse</a>. SpecLynx OpenAPI Toolkit delivers the most effective way to author and manage your API specs, bringing unprecedented ease, pinpoint accuracy, and unmatched power directly to your VSCode workflow</p><br><br></div>`;
